...
if not MANIFEST.exists():
    ...
    frozen={'source_commit':subprocess.check_output(['git','rev-parse','HEAD'],cwd=ROOT,text=True).strip(),
            ...
            'workload':{'seed_entries':20000,'entry_payload_bytes':1024,'memory_edges':2048,
                        'foreground':{'point':60,'projection':4},
                        'additional_mixed':{'scan':16,'background_write':16},'wave_size':16,'projection_schedule':'first four foreground requests; saturation control'},
